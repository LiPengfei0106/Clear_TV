...
import com.lipengfei.tv.ui.activity.PlaybackOverlayActivity;
...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tagKey = getActivity().getIntent().getIntExtra(DetailsActivity.TAGKEY,1);
        position = getActivity().getIntent().getIntExtra(DetailsActivity.POSITION,0);
        isShowList = getActivity().getIntent().getBooleanExtra(DetailsActivity.SHOWLIST,true);
        if (mSelectedMovie != null) {
            ...
            updateBackground(mSelectedMovie.getBackgroundUrl());
...
//                        mAdapter.notifyArrayItemRangeChanged(0, mAdapter.size());
        ...
        updateBackground(mSelectedMovie.getCardImageUrl());
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(DetailsActivity.TAGKEY,tagKey);
                    startActivity(intent);
                } else {
...
//        String subcategories[] = {getString(R.string.related_movies)};
        String subcategories[] = {MovieManager.movieLists.get(tagKey).getCategoryNameByLanguageCode(Variables.language_code)};
        List<Movie> list = MovieManager.movieLists.get(tagKey).movies;
